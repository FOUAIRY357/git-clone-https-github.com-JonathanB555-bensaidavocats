...
const echos = {
  meta: "Projet de tribune, cosignature Gilles Carrez / François Ouairy. Version courte ~4 500 signes. Les passages entre crochets sont à votre main. Version 8 du 4 septembre 2026.",
...
const monde = {
  meta: "Projet de tribune, cosignature Gilles Carrez / François Ouairy. Version longue ~5 500 signes (le chapô sera rédigé par la rédaction). Les passages entre crochets sont à votre main. Version 8 du 4 septembre 2026.",
  titre: "Pacte Dutreil : ni rabot ni statu quo",
  chapo: null,
  corps: [
