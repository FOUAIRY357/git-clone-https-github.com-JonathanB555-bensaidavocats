...
const echos = {
  meta: "Projet de tribune, cosignature Gilles Carrez / François Ouairy. Version courte. Les passages entre crochets sont à votre main. Version 10 du 4 septembre 2026.",
  ...
  corps: [
    ...
    "Ces chiffres méritent mieux qu'un haussement d'épaules. [L'un de nous fut co-rapporteur de la loi de 2003 qui a créé ce dispositif ; l'autre le met en œuvre chaque semaine, pour des entreprises de toutes tailles.] Ce que la Cour documente est exact. La dépense a plus que quadruplé en quatre ans. Des montages logent dans l'exonération de la trésorerie ou de l'immobilier qui n'ont rien à voir avec l'activité. Selon ce même rapport, l'avantage moyen des 1 % de bénéficiaires les mieux servis approche trente millions d'euros. Ces montages doivent sortir du régime. Il y survivra très bien.",
    ...
    "La loi de finances du 19 février 2026 a encore durci l'exercice. L'engagement est porté à huit ans au total, et la fraction de valeur correspondant notamment aux résidences, yachts ou œuvres d'art étrangers à l'exploitation sort désormais de l'assiette exonérée. Ces règles ont quelques mois. Personne n'en a mesuré les effets. En écrire de nouvelles dès cet automne, c'est légiférer à l'aveugle.",
    ...
    "Que faire ? Il ne faut ni raboter ni sanctuariser. Le rabot punirait les PME sans fermer un seul montage. Le statu quo laisserait prospérer ce que la Cour documente. D'abord, ce que les fiscalistes appellent une clause de grand-père. Un pacte signé est un contrat, et un contrat oblige les deux parties. Les familles tiennent huit ans ; l'État tient les règles en vigueur au jour de la signature, jusqu'au terme. Cela ne coûte rien au budget. Pour les pactes nouveaux, la loi fixe ses conditions et le taux de 75 % est maintenu. Ensuite, achever le ciblage. Les biens de confort viennent de sortir de l'assiette. La trésorerie de placement et l'immobilier de rapport y restent. Le même mécanisme, étendu à ces actifs, donnerait au régime sa forme aboutie, 75 % sans plafond pour l'outil professionnel, rien pour le reste. Ce ciblage rapporterait plus qu'un rabot. Et une évaluation publique tous les trois ans, chiffres sur la table, seule occasion de retoucher le régime. Entre deux rendez-vous, le régime ne bouge pas.",
  ...
  signature: "Gilles Carrez, ancien rapporteur général du budget, ancien président de la commission des finances de l'Assemblée nationale, et François Ouairy, avocat fiscaliste associé (BENSAID Avocats)"
};

// ---------- VERSION LE MONDE (~5 000 signes) ----------
const monde = {
  meta: "Projet de tribune, cosignature Gilles Carrez / François Ouairy. Version longue (le chapô sera rédigé par la rédaction). Les passages entre crochets sont à votre main. Version 10 du 4 septembre 2026.",
  titre: "Pacte Dutreil : ni rabot ni statu quo",
  chapo: null,
  corps: [
