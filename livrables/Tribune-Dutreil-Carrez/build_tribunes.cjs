...
const echos = {
  meta: "Projet de tribune, cosignature Gilles Carrez / François Ouairy. Version courte ~4 500 signes. Les passages entre crochets sont à votre main. Version 7 du 4 septembre 2026.",
  ...
  corps: [
    ...
    "Que faire ? D'abord ce que les fiscalistes appellent une clause de grand-père. Un pacte signé est un contrat, et un contrat oblige les deux parties. Les familles tiennent huit ans ; l'État tient les règles en vigueur au jour de la signature, jusqu'au terme. Cela ne coûte rien au budget. Pour les pactes nouveaux, la loi fixe ses conditions, taux de 75 % maintenu. Ensuite, achever le ciblage. La loi écarte désormais de l'exonération les résidences, les yachts ou les œuvres d'art logés dans les sociétés. Elle ne dit toujours rien de la trésorerie de placement ni de l'immobilier de rapport. Le même mécanisme, étendu à ces actifs, donnerait au régime sa forme aboutie, 75 % sans plafond pour l'outil professionnel, rien pour le reste. Ce ciblage rapporterait plus qu'un rabot, qui toucherait d'abord les PME. Et une évaluation publique tous les trois ans, chiffres sur la table, seule occasion de retoucher le régime. Entre deux rendez-vous, le régime ne bouge pas.",
...
const monde = {
  meta: "Projet de tribune, cosignature Gilles Carrez / François Ouairy. Version longue ~5 500 signes (le chapô sera rédigé par la rédaction). Les passages entre crochets sont à votre main. Version 7 du 4 septembre 2026.",
  titre: "Le pacte Dutreil a tenu sous quatre présidents. Le PLF 2027 ne doit pas le rompre.",
  chapo: null,
  corps: [
    ...
    "Rappelons d'où vient ce régime. En 1994, le laboratoire UPSA, fleuron familial d'Agen, passait sous pavillon américain cinq ans après la mort de son dirigeant, droits de succession et ISF aidant. La France taxait alors la transmission en ligne directe jusqu'à 40 %, et moins d'une entreprise sur cinq restait familiale, contre une sur deux en Allemagne. Yvon Gattaz et les entreprises patrimoniales conçoivent alors le pacte d'actionnaires ; Didier Migaud, rapporteur général socialiste, l'inscrit dans la loi de finances pour 2000, un abattement de 50 % sur les successions en échange d'un engagement collectif de conservation. La loi Dutreil du 1er août 2003 l'étend aux donations. La loi PME du 2 août 2005 porte l'abattement à 75 %. Créé sous un gouvernement de gauche, étendu par la droite, assoupli sous Nicolas Sarkozy, maintenu intact sous François Hollande, simplifié en 2019. Quatre présidents, toutes les alternances, aucune rupture. Une idée qui s'est imposée à tous.",
    "L'ordre de grandeur mérite d'être posé. Pour une entreprise valorisée vingt millions d'euros et un enfant repreneur, les droits au décès, sans pacte, atteignent de l'ordre de huit millions d'euros. Avec un pacte, autour de deux. Personne n'a huit millions sur un compte courant. On emprunte, on ponctionne la trésorerie de l'entreprise, ou on vend. Le législateur vient d'ailleurs de durcir l'exercice, engagement porté à huit ans au total et exclusion de l'assiette des résidences, yachts, œuvres d'art et autres biens de confort logés dans les sociétés. Ces règles ont quelques mois. Personne n'en a mesuré les effets. En écrire de nouvelles dès cet automne, c'est légiférer à l'aveugle.",
    ...
    "Puis il y a l'instabilité. Un pacte signé aujourd'hui court jusqu'en 2034 ; d'ici là, huit lois de finances, des doctrines qui bougent, les contours encore discutés de la holding animatrice, cette société de tête dont dépend l'accès au régime pour des milliers de groupes familiaux. Des transmissions se reportent, des réorganisations se figent. On demande aux familles de tenir huit ans. La règle fiscale, elle, ne tient pas huit mois.",
    { sub: "Ce que nous proposons" },
    "D'abord ce que les fiscalistes appellent une clause de grand-père. Un pacte signé est un contrat, et un contrat oblige les deux parties. Les familles tiennent huit ans ; l'État doit tenir les règles en vigueur au jour de la signature, jusqu'au terme, pour tous les pactes en cours. Son coût budgétaire est nul. Aux pactes nouveaux, la loi fixera les conditions qu'elle voudra, taux de 75 % maintenu. Ensuite, achever le ciblage. La loi écarte désormais de l'exonération les résidences, les yachts ou les œuvres d'art logés dans les sociétés. Elle ne dit toujours rien de la trésorerie de placement ni de l'immobilier de rapport. Le même mécanisme, étendu à ces actifs, donnerait au régime sa forme aboutie, 75 % sans plafond pour l'outil professionnel réellement transmis et dirigé, au besoin assorti d'engagements sur l'emploi, rien pour le reste. Ce ciblage rapporterait davantage qu'une baisse de taux, et il répond à la question d'équité par la structure même du régime. Enfin une évaluation publique et indépendante tous les trois ans, seule occasion de retoucher le dispositif. La matière statistique existe, le travail de la Cour et de l'Institut des politiques publiques vient de le montrer. Il manque le rendez-vous.",
    "La campagne présidentielle promet déjà tout et son contraire sur les successions. Ce que demande le pacte Dutreil tient en peu de mots. Des règles fermes sur ce qu'il couvre. Et dix ans de calme."
  ],
  signature: "Gilles Carrez, ancien rapporteur général du budget, ancien président de la commission des finances de l'Assemblée nationale, et François Ouairy, avocat fiscaliste (BENSAID Avocats)"
};
